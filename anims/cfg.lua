...
cfg = {
    commandName = 'ep', -- Open the animations panel
    commandSuggestion = 'Abrir menu de animacoes', -- Open the animations panel suggestion
    ...
    defaultEmoteKey = 899 -- Default emote command key
}